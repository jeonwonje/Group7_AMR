...
options = {
  ...
  odom_frame = "odom",
  provide_odom_frame = false, -- The robot's wheel encoders already provide odom
...
-- CRITICAL: Set to true ONLY if you have a perfectly working /imu topic.
-- Otherwise, Cartographer will freeze instantly waiting for IMU data.
